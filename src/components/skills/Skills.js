        ...
        return ( 
            <div className = "skills-section">
                ...
                <div className = "skills-wrapper">
                    ...
                    <SkillCard icon = {<i class="fas fa-sitemap"></i>} skill = {"Backend Development"} description = {"Robust test driven development with Ruby on Rails, NodeJS, Express and PostgreSQL."} />
                </div>
            </div>
         );
    }
